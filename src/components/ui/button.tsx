...
function Button({
  ...
  const isNative =
    nativeButton ??
    (render
      ? (React.isValidElement(render) && render.type === "button" ? true : false)
      : undefined)
